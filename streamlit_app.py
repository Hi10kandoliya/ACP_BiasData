...
# ─────────────────────────────────────────────────────────────────────────────
    ...
    st.dataframe(
        corr_df.style
               .applymap(lambda v: f"color:{GREEN};font-weight:600" if "Boost" in str(v)
...
# ─────────────────────────────────────────────────────────────────────────────
    ...
    if not fdf.empty:
        ...
        st.dataframe(
            fdf[show_cols].style
               .applymap(lambda v: f"color:{RED};font-weight:600" if v == "HIGH"
...
# ─────────────────────────────────────────────────────────────────────────────
    ...
    st.dataframe(
        display.style
               .applymap(lambda v: f"color:{RED};font-weight:600" if v == "Flag for Review" else "",
                         subset=["feedback_flag"])
               .applymap(lambda v: f"color:{RED}" if isinstance(v, float) and v < -15
